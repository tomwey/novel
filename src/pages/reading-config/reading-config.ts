...
/**
 * Generated class for the ReadingConfigPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-reading-config',
  templateUrl: 'reading-config.html',
})
export class ReadingConfigPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ReadingConfigPage');
    
    this.previewContent();
  }

  previewContent() {
    let div = this.previewContainer.nativeElement as HTMLElement;
    div.style.fontFamily = this.readingConfigs.fontName;
    div.style.color = this.readingConfigs.colorValue;
    div.style.fontSize = this.readingConfigs.fontSize + 'px';
    div.style.letterSpacing = this.readingConfigs.fontSpace + 'px';
    div.style.lineHeight = this.readingConfigs.lineSpace + 'px';
  }
